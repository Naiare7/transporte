"""Creacion de las 10 entidades de transporte

Revision ID: 70db45ee13ad
Revises: 
Create Date: 2026-04-23 09:39:39.645627
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('fecha_creacion', sa.DateTime(), nullable=True),
    sa.Column('se_entrego', sa.Boolean(), nullable=True),
